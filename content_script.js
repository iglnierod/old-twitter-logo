...
if (isTwitterDomain) {
  ...
  // Obtener el elemento SVG dentro del header
  const svgElement = document.querySelector('header svg');

  // Comprobar si se encontró el elemento SVG
  if (svgElement) {
    // Reemplazar el contenido del SVG con el nuevo contenido
    svgElement.parentElement.innerHTML = newSvgContent;
  }
}
